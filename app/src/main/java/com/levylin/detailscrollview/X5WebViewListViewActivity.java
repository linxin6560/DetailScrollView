...
//        String url = "file:///android_asset/test";
        final DetailX5WebView webView = (DetailX5WebView) findViewById(R.id.test_webview);
        ...
        DetailScrollView scrollView = (DetailScrollView) findViewById(R.id.test_sv);
